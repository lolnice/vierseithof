			<div id="content_wrapper">
				<div class="box_big_left">
					<h1>Ein vielfältiges Freizeitangebot erwartet Sie</h1>
					<p>Das kleine Flämingdorf Rietdorf, ruhig gelegen nahe der B 102 zwischen Jüterbog und Luckau, ist ideale Tourenbasis für:</p>
					<ul>
						<li>Die Weltstadt Berlin</li>
						<li>Den Filmpark Babelsberg</li>
						<li>Die Lutherstadt Wittenberg</li>
						<li>Potsdam mit seinen Schlössern</li>
						<li>Dresden mit Semperoper und Zwinger</li>
						<li>Den Spreewald mit seinen Wasserwegen</li>
					</ul>
					...
					<ul>
						...
						<li>Kloster Zinna</li>
						<li>Das Museumsdorf Glashütte</li>
						<li>Die Nachbarländer Polen und Tschechien</li>
					</ul>
				...
				<div class="box_image_right">
					<img src="img/flaeming_skate.jpg" alt="Flaeming Skate" >
				</div>
